	...
	$(document).ready(function(){
		...
		jQuery('#ampaginationsm').on('am.pagination.change',function(e){
			...
			if(search == "search"){
		        ...
		        $(location).attr('href', "http://localhost:9000/notice/admin_notice_list_search.do?rpage="+e.page);
			}else{
				jQuery('.showlabelsm').text('The selected page no: '+e.page);
		       $(location).attr('href', "http://localhost:9000/notice/admin_notice_list.do?rpage="+e.page);
			}
	    });
